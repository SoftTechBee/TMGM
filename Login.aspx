...
<head  runat="server">
    ...
    <title>Login-Page ||TMGM - Forex | Indices | Metals | Shares</title>
            ...
            <div class="authentication-inner">
                ...
                <hr />
                            <div class="mb-3 text-center">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-success  btn-sm" OnClick="btnLogin_Click"   Text="LogIn" />
