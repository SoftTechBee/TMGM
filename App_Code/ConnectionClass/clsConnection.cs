      ...
      public  string ConnectString
        {
            get
            {
                ...
                // Connection in FTP
                    string strConnection = @"Data Source=216.48.177.70;Initial Catalog=TMGMDB;Persist Security Info=True;User Id=TMGM_DB;Password=@pFNun^48rJk8nhv; connection Timeout=20000;Connection Lifetime=0;Min Pool Size=0;Max Pool Size=2000;Pooling=true;";
