...
namespace TripleITTransaction
{
    public class clsList  
    {
        ...
        public DataTable CompanyBankMaster(int Bid, string PaymentMode, string BankName, string Branch, string IFSC, string AccountNumber, string HolderName, string QRCode, string UPI,string Mode, string Transaction)
        {
            ...
            return ObjConnection.ReturnDataTable("[dbo].[BankMaster]", ptmBid, ptmPaymentMode, ptmBankName, ptmBranch, ptmIFSC, ptmAccountNumber, ptmHolderName, ptmQRCode, ptmUPI, ptmMode, ptmTransaction);
        }
        ...
        public DataTable companydetaillist(int Bid, string BankName, string QRCode, string Package, decimal Amount, decimal Rate, decimal PayAmount, string show, string UPI, string Transaction)
        {

            SqlParameter prmBid = new SqlParameter("@Bid", Bid);
            SqlParameter prmBankName = new SqlParameter("@BankName", BankName);
            SqlParameter prmQRCode = new SqlParameter("@QRCode", QRCode);
            SqlParameter prmPackage = new SqlParameter("@Package", Package);
            SqlParameter prmAmount = new SqlParameter("@Amount", Amount);
            SqlParameter prmRate = new SqlParameter("@Rate", Rate);
            SqlParameter prmPayAmount = new SqlParameter("@PayAmount", PayAmount);
            SqlParameter prmshow = new SqlParameter("@show", show);
            SqlParameter prmUPI = new SqlParameter("@UPI", UPI);
            SqlParameter prmTransaction = new SqlParameter("@Transaction", Transaction);
            return ObjConnection.ReturnDataTable("[dbo].[companybankdetail]", prmBid, prmBankName, prmQRCode, prmPackage, prmAmount, prmRate, prmPayAmount, prmshow, prmUPI, prmTransaction);
        }
        public DataTable tblpackagemaster(int PID, string PackageName, decimal PackageAmount, string PV, decimal MatchingIncome, decimal DailyIncome, decimal MonthlyIncome, string URL, string Transaction)
        {

            SqlParameter prmPID = new SqlParameter("@PID", PID);
            SqlParameter prmPackageName = new SqlParameter("@PackageName", PackageName);
            SqlParameter prmPackageAmount = new SqlParameter("@PackageAmount", PackageAmount);
            SqlParameter prmPV = new SqlParameter("@PV", PV);
            SqlParameter prmMatchingIncome = new SqlParameter("@MatchingIncome", MatchingIncome);
            SqlParameter prmDailyIncome = new SqlParameter("@DailyIncome", DailyIncome);
            SqlParameter prmMonthlyIncome = new SqlParameter("@MonthlyIncome", MonthlyIncome);
            SqlParameter prmURL = new SqlParameter("@URL", URL);
            SqlParameter prmTransaction = new SqlParameter("@Transaction", Transaction);
            return ObjConnection.ReturnDataTable("[dbo].[packagemaster]", prmPID, prmPackageName, prmPackageAmount, prmPV, prmMatchingIncome, prmDailyIncome, prmMonthlyIncome, prmURL, prmTransaction);
