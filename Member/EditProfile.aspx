        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="card-header with-border">
                        <h5 class=" card-title text-danger">Admission Details</h5>
                    </div>
            ...
            <div class="col-lg-9">
                    <div class="card-header with-border">
                        <h5 class="card-title text-danger">Personal Detail</h5>
                    </div>
                <div class="card ">
                    <!----form start---->
                    <div class="form-horizontal">
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                <center>
                                    <asp:Button ID="bntsubmit" OnClick="bntsubmit_Click" OnClientClick="return Validate();" runat="server" Text="Save" Width="200px" CssClass="btn  btn-primary text-center btn-lg btn-flat" />
                                    <asp:Button ID="btncencel" runat="server" OnClick="btncencel_Click" Text="Cancel" Width="200px" CssClass="btn  btn-primary text-center btn-lg btn-flat" />
                                </center>
                            </div>
                        </div>
                    </div>
        ...
        <%--<div class="row">
            <div class="col-lg-12">
                <div class="card  card-warning ">
                    <div class="card-header with-border">
                        <h1 class=" card-title">Nomnee Detail</h1>
                    </div>
                    <!----form start---->
                    <div class="form-horizontal">
                        <div class="card-body">
