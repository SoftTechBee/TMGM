...
<div  class="col-lg-12">
           <div class="card ">
              ...
              <h3> <asp:Label ID="txtbalance" runat="server" Text="0"></asp:Label></h3>
                     ...
                     <div class="mb-3 row">
                         ...
                         <%--<label class="control-label col-lg-4 ">Server Charge(2%) </label>     
                        ...
                        <div class="col-lg-2">
                         <asp:TextBox ID="txtTDS" Text="" required="" ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                          ...
                                          <%-- <div class="form-group row">
                          <label class="control-label col-lg-4">Transfer Amount in Fund Wallet </label>
                          <div class="col-lg-6">
   ...
   <asp:Button ID="btnaction" runat="server" Text="Transfer"  OnClick="butsubmit_Click" Width="200px" CssClass=" btn btn-primary btn-flat btn-lg" />
