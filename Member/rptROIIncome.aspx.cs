...
public partial class User_rptCashBack : System.Web.UI.Page
{
    ...
    public void loadaccount(string username)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                grdData.FooterRow.Cells[3].HorizontalAlign = HorizontalAlign.Right;
                grdData.FooterRow.Cells[2].Font.Bold = true;
                grdData.FooterRow.Cells[3].Font.Bold = true;
                //grdData.FooterRow.Cells[3].Font.Bold = true;

                grdData.FooterRow.Cells[3].Text = total.ToString("N2");
                //grdData.FooterRow.Cells[3].Text = Debit.ToString("N2");
            }
            //else
            //{
            //    lbdanger.Visible = true;
            //    lbdanger.Text = "Ops! No Data Found.......";
            //}
