...
public partial class User_Default : System.Web.UI.Page
{
    ...
    protected void bntsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int a = objamd.Register(0, lbSponser.Text, lbSponserName.Text, name, UserName, txtPassword.Text, "", name, "", DOJ, "", "", "", drpcountry.SelectedItem.Text, txtEmail.Text, txtMobile.Text, "Not Active", "", "", "", "", "", "", "", DOB, "", "", "", "", "", "", DOJ, "", DOJ, TransactionPassword, "../dist/img/user2-160x160.jpg", "", "", "N");
            ...
            if (a > 0)
            {
              ...
              lbsuccess.Text = "Account Created : Username: " + UserName + " & Password: " + txtPassword.Text + "";
                ...
                sccess.Visible = true;
                objmail.Sendpass(name, UserName, txtPassword.Text, TransactionPassword, txtEmail.Text);
            ...
            {
                lbinfo.Text = "Password & Confirm Password Did Not Match...try again";
                info.Visible = true;
            }
