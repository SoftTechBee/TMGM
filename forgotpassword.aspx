...
<head  runat="server">
    ...
    <title>Forgot Password - Page |TMGM - Forex | Indices | Metals | Shares</title>

    <meta name="description" content="Achieve new heights of SUCCESS in life Start your own BUSINESS" />
    <meta name="keywords" content="TMGM - Forex | Indices | Metals | Shares, businessTMGM - Forex | Indices | Metals | Shares, login. ">
    <!-- Canonical SEO -->
...
<body id="top" data-theme-color="color-yellow"  style="background-image:url(Loginassets/img/logo/bg.jpg); background-size:cover; background-position:center">
 ...
 <!-- Content -->
    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                <!-- Register -->
                <div class="card">
                   <div class="card-body" style="background:#0a1802; -webkit-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); box-shadow: 0px 0px 10px 5px #000000;">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo ">
                                   ...
                                   <img src="Loginassets/img/logo/logo.png" style="width:230px  !important" />
                        ...
                        <!-- /Logo -->
                        <%--<h4 class="mb-2">Welcome toTMGM - Forex | Indices | Metals | Shares!  </h4>--%>
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-success d-grid w-100" OnClick="btnLogin_Click"   Text="Sent To Mail" />
                        ...
                        <p class="text-center">
                            <span>Back ToTMGM - Forex | Indices | Metals | Shares?</span>
                            <a href="login.aspx">
                                <span>Login</span>
                            </a>
                        </p>
    ...
    <!-- / Content -->
<%-- <div class="buy-now">
        <a href="index.html" target="_blank" class="btn btn-danger btn-buy-now">Back ToTMGM - Forex | Indices | Metals | Shares</a>
    </div>--%>
