...
<head  runat="server">
    ...
    <title>Signup - Page | TMGM - Forex | Indices | Metals | Shares</title>

    <meta name="description" content="Achieve new heights of success in life Start your own business." />
    <meta name="keywords" content="TMGM - Forex | Indices | Metals | Shares, business TMGM - Forex | Indices | Metals | Shares, login ">
    <!-- Canonical SEO -->
                          ...
                          <div class="mb-1 form-password-toggle">
                           ...
                           <hr />
                            <div class="mb-3 text-center">
                                 <asp:Button runat="server" ID="btnRegister" OnClientClick="return validatepassword();" OnClick="btnRegister_Click"  CssClass="btn btn-success  btn-sm"  Text="Create Account" />
