        ...
        <div class="form-horizontal">
            <div class="card-body">
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="col-lg-10">
                        <asp:DropDownList ID="drpBank" runat="server" OnSelectedIndexChanged="drpBank_SelectedIndexChanged" AutoPostBack="true" class="form-control">
                            ...
                            <asp:ListItem Value="0">USDT QR 1</asp:ListItem>
                            <asp:ListItem Value="1">USDT QR 2</asp:ListItem>
                            <%--<asp:ListItem Value="2">INR BANK</asp:ListItem>--%>
                        </asp:DropDownList>
                    </div>
                </div>
                <div id="divupi" runat="server" visible="false" class="form-group row">
                     <label class="control-label  col-lg-2">Payment Mode</label>
                    <div class="col-lg-4">
                        <asp:TextBox ID="txtmode" runat="server" class="form-control" placeholder="Enter Payment Address"></asp:TextBox>
                    </div>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td><%# Container.ItemIndex+1 %></td>
                                         <td>
                                            <asp:Label ID="lbmode" runat="server" Text='<%#Eval("Mode") %>'></asp:Label></td>
                                        <td>
