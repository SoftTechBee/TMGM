...
public partial class User_cryptoWallet1 : System.Web.UI.Page
{
    ...
    protected void bntsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            int a = objamd.CryptoWallet(txtsearch.Text, "", "","", txtUSDT.Text, "", "", "A");
            if (a > 0)
            {
               
                lbinfo.Text = " '"+txtsearch.Text+"' Crypto Wallet updated Successfully";
                info.Visible = true;
            ...
            else if (a == -1)
            {
                ...
                lbinfo.Text = " '" + txtsearch.Text + "' Crypto Wallet already Updated successfully";
                info.Visible = true;
            ...
            else
            {
                ...
                lbinfo.Text = " '" + txtsearch.Text + "' Crypto Wallet have not Updated successfully";
                info.Visible = true;
            }
