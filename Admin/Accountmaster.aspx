...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card-header with-border">
        <h5 class=" card-title text-danger">Fund Wallet Master</h5>
    </div>
    <div class="card">
        <div class="form-horizontal">
            <div class="card-body">
                ...
                <div class=" form-group row">
                    ...
                    <div class="col-lg-6">
                        <asp:TextBox ID="txtusername" placeholder="Enter Member ID" AutoPostBack="true" OnTextChanged="txtusername_TextChanged" required="" runat="server" CssClass="form-control"></asp:TextBox>
                ...
                <div class=" form-group row">
                    ...
                    <div class="col-lg-6">
                        <asp:TextBox ID="txtAmount" placeholder="Enter Deposit Amount" Type="number" required="" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <asp:TextBox ID="txtremarks" required=""  Text="Deposit By Admin!" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
