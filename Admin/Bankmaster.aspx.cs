...
public partial class Admin_Default2 : System.Web.UI.Page
{
    ...
    protected void bntsubmit_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           {
                int a = objamd.CompanyBankMaster(0, drpBank.SelectedItem.Text.Trim(), txtbankname.Text, txtbranch.Text, txtifsc.Text, txtaccountnumber.Text, txtholdername.Text, hndqr.Value,txtaddress.Text,txtmode.Text, "N");
                if (a > 0)
                {
    ...
    protected void drpBank_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (drpBank.SelectedValue == "2")
        {
