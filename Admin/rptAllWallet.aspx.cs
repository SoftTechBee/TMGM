...
public partial class Admin_rptSponser : System.Web.UI.Page
{
    ...
    private void loadlist()
    {
        try
        {
            ...
            {
                sql += "and a.username='" + txtsearch.Text + "'  and  r.dateofjoin between '" + txtfromdate.Text + "' and '" + txttodate.Text + "'";

            }
            else if (txtsearch.Text == "" && txtfromdate.Text != "" && txttodate.Text != "")
            {
                sql += "  and  r.dateofjoin between '" + txtfromdate.Text + "' and '" + txttodate.Text + "'";
            ...
            sql += "group by r.name,r.dateofjoin,a.username order by r.dateofjoin asc";
