...
public partial class Admin_Accountmaster : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //int Active = objamd.ActiveMember(txtusername.Text.Trim(), Convert.ToDecimal(txtAmount.Text), 1, txtremarks.Text, "Admin", "N");
            //if (Active > 0)
            //{
            //    danger.Visible = false;
            //    lbsuccess.Text = "Deposit successfully For ID " + txtusername.Text + " ";
            //    sccess.Visible = true;                
            //    txtremarks.Text = "";
            //    txtAmount.Text = "";
            //    txtusername.Text = "";
            ...
            //    lbdanger.Text = "Something Wrong! Try Again...! ";
            //    danger.Visible = true;
            //}
