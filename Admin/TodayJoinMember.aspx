<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="TodayJoinMember.aspx.cs" Inherits="Admin_DirectList" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-header with-border">
                <h5 class=" card-title text-danger">Today Joined Members</h5>
            </div>
            <div class="card ">
                <div class="card-body">
