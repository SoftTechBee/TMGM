...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="alert alert-danger alert-dismissible" id="danger" runat="server" visible="false">
        ...
        <div class="card-header with-border">
            <h5 class=" card-title text-danger">Blocked Member Details</h5>
        </div>
    <div class="card">
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand1">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="Button1" runat="server" Text="Active" CssClass="btn  btn-block btn-success" CommandArgument='<%#Eval("username") %>' CommandName="Click" />
                                            </td>
                                        </tr>
